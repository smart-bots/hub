...
//#define ssid "namba"
//#define password "goventi23"
//#define ssid "Duc Duy Wifi"
//#define password "1tu2duy3"
//#define ssid "TP-LINK_9688FA"
//#define password "18538328"
#define ssid "B.O.T"
#define password "kimoanh104"
#define server "192.168.43.7"
#define port 80
#define apiKey "xrDo1wvU1tz1wshwuWbborycjemnPjmN6obZhsXcULACnp1Xyt"
...
void loop() {
  ...
  if (radio.available()) {
    ...
    tus = down[10];
    hard = down[11];
    uri     = "/ss/api/" + String(apiKey) + "/up/" + String(key) + "/" + String(tus) + "/" + String(hard);
      ...
      if (Serial1.find(">")) {
        ...
        if (Serial1.find("SEND OK\r\n")) {
          ...
          if (Serial1.find("\r\n\r\n")) {
            ...
            while (i < 60000) { // Kiểm tra thời gian
